...
export default function HomeClient() {
  ...
  return (
    <main dir="rtl" className={`vibe-site ${theme}`}>
      ...
      <section className="enroll-section"><div className="enroll-orb orb-a" /><div className="enroll-orb orb-b" /><div className="vibe-container enroll-content"><span className="enroll-mini-logo">V</span><h2>با یک ایده وارد شو؛<br />با یک <span>لینک واقعی</span> بیرون برو.</h2><p>VibeLab برای تولیدکننده‌ها، فریلنسرها، صاحبان کسب‌وکار و هر کسی است که می‌خواهد با هوش مصنوعی سریع‌تر بسازد.</p><div className="enroll-actions"><a href="/register" className="enroll-button">رزرو جایگاه و سنجش مسیر <Icon name="arrow" size={18} /></a><a href="/internship" className="enroll-telegram"><Icon name="tool" size={17} /> کارآموزی طراحی سایت و محتوا</a><a href="https://t.me/ai_vibelab_bot" className="enroll-telegram" target="_blank" rel="noreferrer"><Icon name="spark" size={17} /> ربات VibeLab</a><a href="https://t.me/vibelab_channel" className="enroll-telegram" target="_blank" rel="noreferrer"><Icon name="share" size={17} /> کانال آموزش VibeLab</a></div><div className="enroll-features"><span><Icon name="users" size={15} /> ظرفیت محدود برای بازخورد واقعی</span><i /><span><Icon name="globe" size={15} /> قابل شرکت به‌صورت آنلاین</span></div></div></section>
